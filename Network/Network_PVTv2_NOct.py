...
class FMFS(nn.Module):
    def __init__(self, channels=128):
        ...
        self.frb_4 = FeatureRefineBlock(in_channel=512, out_channel=512)
        ...
        self.fem_4 = FrequencyEnhancedModule(32 ,1)
    ...
    def forward(self, x):
        ...
        x4 = self.frb_4(s4)                                                                      # (8, 640, 7, 7)
        x4_up_1 = F.pixel_shuffle(x4, 2)                                            # (8, 128, 14, 14)
        x4_up_2 = F.pixel_shuffle(x4_up_1, 2)                                       # (8, 32, 28, 28)
        x4_f = self.fem_4(x4_up_2)                       # (8, 32, 28, 28)


        x4_f_a = self.conv_4(x4_f)   # (8, 1, 28, 28)
...
# # Calculate FLOPs and MACs   MACs: 20.71 G    FLOPs: 20.75 G  parameters: 106.08 M
