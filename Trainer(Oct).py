...
def parser():
    ...
    parser.add_argument('--checkpoint', default='../FMFS-Net/checkpoints/Net_epoch_best(oct).pth', type=str)  # Oct Abolation
...
class Trainer:
    def __init__(self, args):
        ...
        # 初始化用于存储每个epoch的损失值
        self.epoch_losses = {'total_loss': [], 'loss_1': [], 'loss_2': [], 'loss_3': [], 'loss_4': []}
    ...
    def train_epoch(self, epoch):
        self.model.train()
        total_loss = 0.0
        total_parts = [0.0] * 4  # loss_1 ~ loss_5
        ...
        for images, masks in loop:
            ...
            loss, l1, l2, l3, l4  = self.Loss_Function((p1, p2, p3, p4), masks)
    ...
    def Loss_Function(self, preds, mask):
        ...
        total_loss = (loss_1 + 0.6 * loss_2 + 0.4 * loss_3 + 0.3 * loss_4 )
